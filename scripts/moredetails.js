...
const product = products[productId];
  ...
  // Event listeners for review stars
  ...
  // Adding an event listener for the Enter key in the review text field
  ...
  // Function to reset stars after mouseout
  function resetStars() {
    document.querySelectorAll('.star').forEach(star => {
        star.classList.remove('hover');
    });
  ...
  function displayReviews() {
    ...
    if (reviews[productId]) {
        ...
        // Add event listeners for removing reviews
  ...
  function getCurrentUserId() {
    ...
    return "Anonymous"; // If there is no logged-in user
  }
  ...
  // Function to prompt for creating an account
  function promptCreateAccount() {
    alert('Please create an account or log in to submit a review.');
    // Here you can add redirection to the account creation page
  }
